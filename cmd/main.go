...
import (
	...
	"github.com/mamrezb/maintenance-window-manager/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "42702127.mamrezb.com",
	...
	if err = (&controller.ServiceCheckerReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ServiceChecker")
		os.Exit(1)
	}
